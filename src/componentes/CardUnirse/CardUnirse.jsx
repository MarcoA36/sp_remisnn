...
const CardUnirse = () => {
  return (
    <div className="row card__unirse card__unirse--1 align-items-center bg-dark rounded-3 py-1 p-lg-4">
        ...
        <div className="col-lg-6 py-2 p-lg-4 rounded">
          <div className="card__texto text-white text-center px-1 py-2 py-lg-4">
